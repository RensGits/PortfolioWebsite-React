...
function Home () {
    return (
        ...
        <motion.div key = 'home'  className = 'homeBody' initial = {{opacity: 0, x:0}} animate = {{opacity: 1}} exit = {{opacity: 0}} transition = {{duration:1}}>
            ...
            <ProjectItem conditionalButtonLink = '/virus' blockright = 'projectBlockRight brownobrown '  link = '/virus' className = 'projectImageThree' image = 'https://i.imgur.com/7hVFTpz.png' duration = '1' projectname = 'Virus - learn something' category = 'Dart / flutter application'description = 'VIRUS is a playstore live application that gives information on clinically imortant viruses. Virus was my first ever coding project and thought me alot about the road from setting up a project to finalising publication.'  />
            <ProjectItem blockright = 'projectBlockRight' link = '/weeddoctor' className = 'projectImage' image = 'https://i.imgur.com/SuW4e4x.png' duration = '1.2' projectname = 'Weed Doctor' category = 'Dart / flutter application' description = 'Weed Doctor is an application that helps users identify plant diseases based on visual keys in the leaves. ' />
