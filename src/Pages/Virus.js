...
function Virus () {
    ...
    return (
        ...
        <motion.div initial = {{y: -100}} animate = {{y:0}} exit = {{y: 0}} transition = {{duration: 1.1}} className = 'sectionTwo'><img id = 'imageOne' className = 'virusAppImgSectionTop' src="https://i.imgur.com/7hVFTpz.png" alt=""/></motion.div>
